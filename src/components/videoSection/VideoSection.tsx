    ...
    <section className="text-white py-16 ">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto">
          Create groundbreaking gaming experiences accessible from any device, anywhere in the world. 
          Harness the power of Unreal Engine and cloud technology to stream high-quality gameplay, from immersive VR to interactive web platforms.
        </p>
