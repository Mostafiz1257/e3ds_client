    ...
    <nav className="bg-black shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <Link href={'/'}>
          ...
          <Link href={'/admin'}>
          <li className="hover:text-[#003580] cursor-pointer">About/Admin</li>
          </Link>
        ...
        <div className="flex space-x-4 text-white items-center justify-center">
          <FaFacebook className="hover:text-[#003580] cursor-pointer" size={20} />
          <FaTwitter className="hover:text-[#003580] cursor-pointer" size={20} />
          <FaInstagram className="hover:text-[#003580] cursor-pointer" size={20} />
          <FaLinkedin className="hover:text-[#003580] cursor-pointer" size={20} />
          <Link href={'/login'}>
